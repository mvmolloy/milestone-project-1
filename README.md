...
**ScrollSpy** works regardless of the order sections are viewed in. Testing showed I had to go back and offset scrolling by the nav height. This was fixed by adding the Bootstrap class of "offset=50" to the ScrollSpy so now the links change to active at the correct position.   
